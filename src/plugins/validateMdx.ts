...
function validateAST(ast: Program): void {
    ...
    function checkJsxProp(node: SpreadElement | Property, component: SpreadElement | Expression) {
    ...
    function check(node: NodeType): void | boolean {
        ...
        switch (true) {
            ...
            case node.type === 'MemberExpression': {
                ...
                throw new Error(`${node.type}.object.type ${node.object.type} is not allowed here`);
            }
